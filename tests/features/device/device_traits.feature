...
# Preamble
# The following expressions were captured in a prospective
# customer interview as they brainstormed the features of an
# imaginary device, sparked by an agreement that one downside
# of #being independent of a walking cane is that one is not #recognized as an an individual that might need a little extra #consideration.
#• Emoji • fun
#• noticeable
...
#• Any Brittan Creek device needs to be over-the-air (OTA) #updatable at the consent of the user. This interface again #will need to cater for differently-abled users, and requires a #pyboard-compatible development platform.ß
